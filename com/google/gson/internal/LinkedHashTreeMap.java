...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03181();
    ...
    static class C03181 implements Comparator<Comparable> {
        C03181() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05021 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05021() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05031 extends LinkedTreeMapIterator<K> {
            C05031() {
                super();
            }
