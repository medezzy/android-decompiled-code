...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03191();
    ...
    static class C03191 implements Comparator<Comparable> {
        C03191() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C05041 extends LinkedTreeMapIterator<Entry<K, V>> {
            C05041() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C05051 extends LinkedTreeMapIterator<K> {
            C05051() {
                super();
            }
