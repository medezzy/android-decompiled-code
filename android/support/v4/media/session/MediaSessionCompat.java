...
public class MediaSessionCompat {
    ...
    class C04351 extends Callback {
        C04351() {
        }
    }

    class C04362 extends Callback {
        C04362() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C04371();
        ...
        class C04371 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C04371() {
            }
