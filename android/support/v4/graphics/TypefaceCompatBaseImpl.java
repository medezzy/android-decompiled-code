...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C04241 implements StyleExtractor<FontInfo> {
        C04241() {
        }
    ...
    class C04252 implements StyleExtractor<FontFileResourceEntry> {
        C04252() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C04241());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C04252());
    }
