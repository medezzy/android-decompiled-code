...
public class Toolbar extends ViewGroup {
    ...
    class C04791 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C04791() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03011();
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C03011 implements ClassLoaderCreator<SavedState> {
            C03011() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C04791();
        this.mShowOverflowMenuRunnable = new C02992();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C03003());
        }
    }
