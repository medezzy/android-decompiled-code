...
import android.support.v7.recyclerview.C0241R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02813();
    ...
    static class C02813 implements Interpolator {
        C02813() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04761();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04772();
        private int mWidth;
        ...
        class C04772 implements Callback {
            C04772() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0241R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0241R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0241R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0241R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0241R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C04734 implements ProcessCallback {
        C04734() {
        }
    ...
    class C04745 implements Callback {
        C04745() {
        }
    ...
    class C04756 implements Callback {
        C04756() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02821 implements ClassLoaderCreator<SavedState> {
            C02821() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02791();
        ...
        this.mItemAnimatorRunner = new C02802();
        this.mViewInfoProcessCallback = new C04734();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0241R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0241R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0241R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0241R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0241R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0241R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0241R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0241R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04745());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04756());
    }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0241R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0241R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0241R.dimen.fastscroll_margin));
    }
