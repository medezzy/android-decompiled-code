...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C04802();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C03061();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C03081();
        private static final Interpolator sDragViewScrollCapInterpolator = new C03092();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        static class C03081 implements Interpolator {
            C03081() {
            }
        ...
        static class C03092 implements Interpolator {
            C03092() {
            }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0241R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C03101 implements AnimatorUpdateListener {
            C03101() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03101());
    ...
    class C04802 implements OnItemTouchListener {
        C04802() {
        }
    ...
    class C04825 implements ChildDrawingOrderCallback {
        C04825() {
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0241R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0241R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04825();
            }
