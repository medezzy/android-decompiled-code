...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C02431();
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C02441();
            ...
            class C02441 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C04582.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C04582.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C04582.this.mQueue.removeMessages(2);
                                    C04582.this.mQueue.removeMessages(3);
                        ...
                        C04582.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
