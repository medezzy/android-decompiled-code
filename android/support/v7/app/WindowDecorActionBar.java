...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C06111();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C06122();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04533();

    class C04533 implements ViewPropertyAnimatorUpdateListener {
        C04533() {
        }
    ...
    class C06111 extends ViewPropertyAnimatorListenerAdapter {
        C06111() {
        }
    ...
    class C06122 extends ViewPropertyAnimatorListenerAdapter {
        C06122() {
        }
