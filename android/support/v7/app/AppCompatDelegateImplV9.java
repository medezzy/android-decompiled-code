...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C02365 implements Runnable {
        ...
        class C06081 extends ViewPropertyAnimatorListenerAdapter {
            C06081() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C06081());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C04492 implements OnApplyWindowInsetsListener {
        C04492() {
        }
    ...
    class C04503 implements OnFitSystemWindowsListener {
        C04503() {
        }
    ...
    class C04514 implements OnAttachListener {
        C04514() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C06101 extends ViewPropertyAnimatorListenerAdapter {
            C06101() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C06101());
            }
    ...
    class C06096 extends ViewPropertyAnimatorListenerAdapter {
        C06096() {
        }
        ...
        if (a.hasValue(C0239R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C04492());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C04503());
                }
            ...
            contentView.setAttachListener(new C04514());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C06096());
                    } else {
