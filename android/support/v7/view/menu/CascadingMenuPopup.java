...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02462();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02451();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C04593();
    ...
    class C02462 implements OnAttachStateChangeListener {
        C02462() {
        }
    ...
    class C04593 implements MenuItemHoverListener {
        C04593() {
        }
