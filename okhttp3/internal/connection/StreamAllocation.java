...
public final class StreamAllocation {
    ...
    private okhttp3.internal.connection.RealConnection findConnection(int r10, int r11, int r12, boolean r13) throws java.io.IOException {
        ...
        monitor-enter(r5);
        r4 = r9.released;	 Catch:{ all -> 0x0010 }
    ...
    L_0x0017:
        ...
        throw r4;	 Catch:{ all -> 0x0010 }
    L_0x0020:
        r4 = r9.canceled;	 Catch:{ all -> 0x0010 }
    ...
    L_0x0024:
        ...
        throw r4;	 Catch:{ all -> 0x0010 }
    L_0x002d:
        r0 = r9.connection;	 Catch:{ all -> 0x0010 }
    ...
    L_0x0037:
        ...
        r6 = r9.connectionPool;	 Catch:{ all -> 0x0010 }
        r7 = r9.address;	 Catch:{ all -> 0x0010 }
        r8 = 0;
        r4.get(r6, r7, r9, r8);	 Catch:{ all -> 0x0010 }
        r4 = r9.connection;	 Catch:{ all -> 0x0010 }
    ...
    L_0x0054:
        r5 = r9.connectionPool;
        monitor-enter(r5);
        r4 = r9.canceled;	 Catch:{ all -> 0x0064 }
        if (r4 == 0) goto L_0x0067;
    L_0x005b:
        r4 = new java.io.IOException;	 Catch:{ all -> 0x0064 }
        r6 = "Canceled";
    ...
    L_0x0064:
        ...
        throw r4;
    L_0x0067:
        r4 = okhttp3.internal.Internal.instance;	 Catch:{ all -> 0x0064 }
        r6 = r9.connectionPool;	 Catch:{ all -> 0x0064 }
        r7 = r9.address;	 Catch:{ all -> 0x0064 }
        r4.get(r6, r7, r9, r2);	 Catch:{ all -> 0x0064 }
        r4 = r9.connection;	 Catch:{ all -> 0x0064 }
        if (r4 == 0) goto L_0x0078;
    L_0x0074:
        r0 = r9.connection;	 Catch:{ all -> 0x0064 }
        monitor-exit(r5);	 Catch:{ all -> 0x0064 }
        goto L_0x0036;
    L_0x0078:
        ...
        r1 = new okhttp3.internal.connection.RealConnection;	 Catch:{ all -> 0x0064 }
        r4 = r9.connectionPool;	 Catch:{ all -> 0x0064 }
        ...
        r5 = r9.connectionPool;
        monitor-enter(r5);
        r4 = okhttp3.internal.Internal.instance;	 Catch:{ all -> 0x00ba }
        r6 = r9.connectionPool;	 Catch:{ all -> 0x00ba }
        r4.put(r6, r1);	 Catch:{ all -> 0x00ba }
        r4 = r1.isMultiplexed();	 Catch:{ all -> 0x00ba }
        if (r4 == 0) goto L_0x00b3;
    L_0x00a7:
        r4 = okhttp3.internal.Internal.instance;	 Catch:{ all -> 0x00ba }
        r6 = r9.connectionPool;	 Catch:{ all -> 0x00ba }
        r7 = r9.address;	 Catch:{ all -> 0x00ba }
        r3 = r4.deduplicate(r6, r7, r9);	 Catch:{ all -> 0x00ba }
        r1 = r9.connection;	 Catch:{ all -> 0x00ba }
    L_0x00b3:
