...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C03841();
    ...
    class C03841 implements Comparator<String> {
        C03841() {
        }
    ...
    class C03852 implements ThreadFactory {
        final /* synthetic */ boolean val$daemon;
        final /* synthetic */ String val$name;

        C03852(String str, boolean z) {
            this.val$name = str;
            this.val$daemon = z;
        }
